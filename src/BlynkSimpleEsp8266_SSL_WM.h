...
#define BLYNK_WM_VERSION       "Blynk_WM SSL for ESP8266 v1.6.2"
...
//default to use EEPROM, otherwise, use LittleFS or SPIFFS
    ...
    #warning Using LittleFS in BlynkSimpleEsp8266_SSL_WM.h
  #else
    #define FileFS    SPIFFS
    #warning Using SPIFFS in BlynkSimpleEsp8266_SSL_WM.h
  #endif
...
#else
  #include <EEPROM.h>
  #warning Using EEPROM in BlynkSimpleEsp8266_SSL_WM.h
#endif
...
const char BLYNK_WM_HTML_HEAD_START[] /*PROGMEM*/ = "<!DOCTYPE html><html><head><title>BlynkSimpleEsp8266_SSL_WM</title>";
